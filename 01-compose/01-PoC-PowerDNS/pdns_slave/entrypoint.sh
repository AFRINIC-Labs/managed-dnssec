...
# nsd.tld tsig
pdnsutil create-slave-zone nsd.tld 172.16.10.5
pdnsutil import-tsig-key nsd_slave_key hmac-sha256 'TlNEX1RTSUdfU0VDUkVUX0tFWQo='
pdnsutil activate-tsig-key nsd.tld nsd_slave_key slave

# bind.tld tsig
pdnsutil create-slave-zone bind.tld 172.16.10.6
pdnsutil import-tsig-key bind_slave_key hmac-sha256 'QklORF9UU0lHX1NFQ1JFVF9LRVkK'
pdnsutil activate-tsig-key bind.tld bind_slave_key slave
